...
//            }
    ...
    private View.OnClickListener TabClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.menu_tab_breakfast:   setAdapterItems(TIME_TYPE_BREAKFAST);    break;
                case R.id.menu_tab_lunch:       setAdapterItems(TIME_TYPE_LUNCH);       break;
                case R.id.menu_tab_dinner:      setAdapterItems(TIME_TYPE_DINNER);      break;
    ...
    class MenuAdapter extends BaseAdapter {
        ...
        private int getPlaceIcon(String url){
            ...
            switch (url){
                case TO_BIBIM:  returnValue = R.drawable.icon_bibin;    break;
                case DODAM:     returnValue  = R.drawable.icon_dodam;   break;
                case WOORI:     returnValue = R.drawable.icon_woori;    break;
                ...
                case SPRING:    returnValue = R.drawable.icon_soban;    break;
                ...
                case GATS:      returnValue = R.drawable.icon_gach;     break;
                case SINGFU:    returnValue = R.drawable.icon_xingfu;   break;
                case BROWN:     returnValue = R.drawable.icon_grill;    break;
